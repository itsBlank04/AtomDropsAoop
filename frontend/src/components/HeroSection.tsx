...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    title: 'Repair Hub',
      description: 'Find certified technicians for your devices. Phones, laptops, appliances — fast turnaround with genuine parts and warranty.',
    cta: { text: 'Explore repair hub', to: '/repair' },
    icon: 'handyman',
    gradient: 'from-[#f9f5f0] via-[#f0e8df] to-[#e4d6c8]',
    ringColor: 'ring-[#c4956a]/20',
