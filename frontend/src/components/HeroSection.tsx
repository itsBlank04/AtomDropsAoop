...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    title: 'Repair Hub',
      description: 'Browse thousands of genuine electronics from trusted sellers. Phones, laptops, accessories — all verified and protected.',
    cta: { text: 'Browse products', to: '/products' },
    icon: 'handyman',
    gradient: 'from-[#f9f5f0] via-[#f0e8df] to-[#e4d6c8]',
    ringColor: 'ring-[#c4956a]/20',
