...
import com.atomdrops.repair.repository.TechnicianAvailabilityRepository;
import com.atomdrops.repair.repository.TechnicianEarningRepository;
...
public class TechnicianController {
    ...
    public List<com.atomdrops.repair.model.RepairReview> getTechnicianReviews(@PathVariable Long id) {
        return repairReviewRepository.findByTechnicianId(id);
    }

    @GetMapping("/technicians/{id}/services")
    public List<com.atomdrops.repair.model.ServiceListing> getTechnicianServices(@PathVariable Long id) {
